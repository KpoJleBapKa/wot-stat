...
public class PlayerStatistics {
    ...
    public static void displayPlayerStats(JSONObject playerObject) {
    ...
    private static JSONObject getStatistics(long accountId) {
        try {
            String apiUrl = App.WOT_API_URL + "/account/info/?application_id=" + App.APPLICATION_ID + "&account_id=" + accountId;
    ...
    private static JSONObject getClanInfo(long clanId) {
        try {
            String apiUrl = App.WOT_API_URL + "/clans/info/?application_id=" + App.APPLICATION_ID + "&clan_id=" + clanId;
